import { Mesh, Vector3, Renderer as Renderer$1, Raycaster, Vector2, Intersection, Euler, WebGLRenderer, Object3D, Texture, WebGLRendererParameters, BufferGeometry, ShaderMaterial } from 'three';
...
declare class Renderer extends AbstractService {
     ...
     * @deprecated
     */
    setOverlay(textureData: TextureData, opacity: number): void;
    /**
...
declare abstract class AbstractAdapter<TPanorama, TTexture, TData> {
     ...
     * @deprecated
     */
    static readonly supportsOverlay: boolean;
    constructor(viewer: Viewer);
    /**
     ...
     */
    abstract loadTexture(panorama: TPanorama, newPanoData?: PanoData | PanoDataProvider, loader?: boolean, useXmpPanoData?: boolean): Promise<TextureData<TTexture, TPanorama, TData>>;
    /**
     * Creates the mesh
     */
 ...
 */
type PanoramaOptions = Partial<ExtendedPosition> & {
    /**
 ...
 */
type ReadonlyViewerConfig = 'panorama' | 'panoData' | 'overlay' | 'overlayOpacity' | 'container' | 'adapter' | 'plugins';
/**
 ...
 */
declare function getStyle(elt: Element, prop: string): string;
/**
...
declare const index_getStyle: typeof getStyle;
...
declare class EquirectangularAdapter extends AbstractAdapter<string, Texture, PanoData> {
    ...
    loadTexture(panorama: string, newPanoData?: PanoData | PanoDataProvider, loader?: boolean, useXmpPanoData?: boolean): Promise<EquirectangularTexture>;
    /**
    ...
    setOverlay(mesh: EquirectangularMesh, textureData: EquirectangularTexture, opacity: number): void;
