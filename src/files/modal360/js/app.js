...
;// CONCATENATED MODULE: ./src/js/modules/plugins.js
...
;// CONCATENATED MODULE: ./src/files/media_copy_right/js/settings.js
const IS_MOBILE = window.matchMedia("(max-width:479.98px)").matches;
const FONT_URL = 'https://fonts.googleapis.com/css2?family=Montserrat&display=swap';
;// CONCATENATED MODULE: ./src/files/media_copy_right/js/get_copy_right_for_media.js
...
;// CONCATENATED MODULE: ./src/files/media_copy_right/js/set_copytight_to.js

function setCopyRightTo(destination, isNewLine) {
...
;// CONCATENATED MODULE: ./src/js/sections/alter_parent_window.js
...
;// CONCATENATED MODULE: ./src/js/sections/gallery.js
...
;// CONCATENATED MODULE: ./src/js/sections/swiper/haveIntExt.js
...
;// CONCATENATED MODULE: ./src/files/media_copy_right/js/media_copy_right_fonts.js
function mediaCopyRightFonts(link) {
...
;// CONCATENATED MODULE: ./src/files/media_copy_right/js/append_copy_right_styles_for_media.js
function appendCopyRightStylesForMedia(link) {
...
;// CONCATENATED MODULE: ./src/files/media_copy_right/js/set_styles_for_media_copy_right.js




function setStylesForMediaCopyRight() {
...
;// CONCATENATED MODULE: ./src/js/components/queries.js

const IS_IPADE = queryMatches("(max-width:1170px)");
const IS_TABLETS = queryMatches("(max-width:991.98px)");
;// CONCATENATED MODULE: ./src/js/sections/viewer/viewer_instance.js


/**
   * viewer initialization
   */
const viewerInstance = new PhotoSphereViewer.Viewer({
...
;// CONCATENATED MODULE: ./src/js/sections/viewer/handle_viewer_panorama.js


function handleViewPanorama(viewer) {
...
;// CONCATENATED MODULE: ./src/js/sections/viewer/events/click.js
...
;// CONCATENATED MODULE: ./src/js/sections/viewer/events/ready.js


function ready(viewerInstance) {
...
;// CONCATENATED MODULE: ./src/js/sections/viewer/events/fullscreen.js


function fullscreen(viewerInstance) {
...
;// CONCATENATED MODULE: ./src/js/sections/viewer/events/handle_events.js
...
;// CONCATENATED MODULE: ./src/js/sections/viewer/viewer.js
...
;// CONCATENATED MODULE: ./src/js/sections/swiper/config.js


function config(amountViewerSlides) {
...
;// CONCATENATED MODULE: ./src/js/sections/swiper/swiper_instance.js

core.use([Navigation]);

const swiperInstance = new core(".swiper", {
  spaceBetween: 2,
  navigation: {
    nextEl: ".swiper-button-next",
    prevEl: ".swiper-button-prev",
...
;// CONCATENATED MODULE: ./src/js/sections/swiper/get_amount_viewer_slides.js
function getAmountViewerSlides(lenght1, length2) {
  return lenght1 ? lenght1 : length2;
}
;// CONCATENATED MODULE: ./src/js/sections/swiper/get_handler_swiper_perview.js
function getHandlerSwiperPerView(viewerSwiperPrerView) {
...
;// CONCATENATED MODULE: ./src/js/sections/swiper/get_handler_for_swiper_update.js
function getHandlerForSwiperUpdate(getSwiperWidthAndCount, getSwiperPerView, swiper) {
...
;// CONCATENATED MODULE: ./src/js/sections/swiper/viewerSwiper.js
...
;// CONCATENATED MODULE: ./src/js/sections/popups.js
